...
## Comenzar a chatear <a id="comenzar-chat"></a><a id="2"/>
...
3.  Si no encuentra un contacto, puede [añadirlo por el número de teléfono](#Cómopuedoañadircontactosporsunúmerodeteléfono) o introducir su «ID» de Matrix en el campo de búsqueda. (¿Qué es una identificación («ID») de Matrix?](#1-4))
4.  Vaya a «crear chat»
...
## Configuración del chat <a id="configuracion-chat"></a><a id="3"/>
...
## Acerca de FluffyChat <a id="acerca-de-fluffychat"></a><a id="6"/>
